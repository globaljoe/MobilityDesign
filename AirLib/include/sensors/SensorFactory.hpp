...
#include "sensors/pressure/PressureSimple.hpp"
    ...
    public:
            ...
            const AirSimSettings::SensorSetting* sensor_setting) const
        {
            ...
            case SensorBase::SensorType::Pressure:
                return std::shared_ptr<PressureSimple>(new PressureSimple(*static_cast<const AirSimSettings::PressureSetting*>(sensor_setting)));
            default:
