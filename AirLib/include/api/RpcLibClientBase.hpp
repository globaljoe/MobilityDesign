...
namespace airlib
{
    ...
    public:
        ...
        msr::airlib::GpuSonarData getGpuSonarData(const std::string& sonar_name = "", const std::string& vehicle_name = "") const;
        msr::airlib::GpuSidescanSonarData getGpuSidescanSonarData(const std::string& sonar_name = "", const std::string& vehicle_name = "") const;
        ...
        msr::airlib::PressureBase::Output getPressureData(const std::string& pressure_name = "", const std::string& vehicle_name = "") const;
        ...
        msr::airlib::DvlData getDvlData(const std::string& dvl_name = "", const std::string& vehicle_name = "") const;
        ...
        bool simPlayBackTrajectory(const std::vector<Pose>& trajectory, const std::vector<TTimePoint>& time_stamps, const std::string& vehicle_name = "");
