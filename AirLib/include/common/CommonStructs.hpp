...
namespace airlib
{
    ...
    struct GpuSonarData
    {
        TTimePoint time_stamp = 0;
        // data
        // - array of floats that represent [r,theta,intensity] coordinate for each point hit within the range
        //       r0, theta0, intensity0, r1, theta1, intensity1, ..., rn, thetan, intensityn
        // - in sonar local NED coordinates
        // - in meters, radian and unit
        real_T min_range; //m
        real_T max_range; //m
        vector<real_T> sonar_raw_data;
        vector<int> segmentation_sonar;
        vector<real_T> point_cloud;
        vector<int> segmentation;
        Pose pose;
    ...
    struct GpuSidescanSonarData
    {
        ...
        real_T min_range; //m
        real_T max_range; //m
        vector<real_T> port_raw_data;
        vector<int> port_segmentation;
        vector<real_T> port_point_cloud;
        vector<int> port_segmentation_cloud;

        vector<real_T> starboard_raw_data;
        vector<int> starboard_segmentation;
        vector<real_T> starboard_point_cloud;
        vector<int> starboard_segmentation_cloud;
