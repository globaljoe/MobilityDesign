    ...
    namespace msr
{
    namespace airlib
    {
        ...
        {
            return pimpl_->client.call("getGpuSonarData", sonar_name, vehicle_name).as<RpcLibAdaptorsBase::GpuSonarData>().to();
        }

        msr::airlib::GpuSidescanSonarData RpcLibClientBase::getGpuSidescanSonarData(const std::string& sonar_name, const std::string& vehicle_name) const
        {
            return pimpl_->client.call("getGpuSidescanSonarData", sonar_name, vehicle_name).as<RpcLibAdaptorsBase::GpuSidescanSonarData>().to();
        }
        ...
        msr::airlib::PressureBase::Output RpcLibClientBase::getPressureData(const std::string& pressure_name, const std::string& vehicle_name) const
        {
            return pimpl_->client.call("getPressureData", pressure_name, vehicle_name).as<RpcLibAdaptorsBase::PressureData>().to();
        }
        ...
        {
            return pimpl_->client.call("getDvlData", dvl_name, vehicle_name).as<RpcLibAdaptorsBase::DvlData>().to();
        }
        ...
        bool RpcLibClientBase::simPlayBackTrajectory(const std::vector<Pose>& trajectory, const std::vector<TTimePoint>& time_stamps, const std::string& vehicle_name)
        {
        //     return pimpl_->client.call("simPlayBackTrajectory", RpcLibAdaptorsBase::PoseTrajectory(trajectory, time_stamps), vehicle_name);
            return false;
        }
