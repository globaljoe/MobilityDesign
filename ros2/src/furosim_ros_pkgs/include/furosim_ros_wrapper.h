...
#include "furosim_settings_parser.h"
#include "common/AirSimSettings.hpp"
#include "common/common_utils/FileSystem.hpp"
#include "sensors/lidar/LidarSimpleParams.hpp"
#include "sensors/gpu_sonar/GpuSonarSimpleParams.hpp"
#include "sensors/gpu_sidescan_sonar/GpuSidescanSonarSimpleParams.hpp"
...
#include <furosim_interfaces/msg/vel_cmd.hpp>
#include <furosim_interfaces/msg/vel_cmd_group.hpp>
#include <furosim_interfaces/msg/car_controls.hpp>
#include <furosim_interfaces/msg/car_state.hpp>
#include <furosim_interfaces/msg/environment.hpp>
...
#include <furosim_interfaces/msg/altimeter.hpp> //hector_uav_msgs defunct?
...
struct SensorPublisher
{
    ...
    int image_height = 0; // for sonar sensors
    int image_width = 0;  // for sonar sensors
};
...
class AirsimROSWrapper
{
    ...
    using GpuSonarSetting = msr::airlib::AirSimSettings::GpuSonarSetting;
    using GpuSidescanSonarSetting = msr::airlib::AirSimSettings::GpuSidescanSonarSetting;
...
public:
    ...
    bool is_used_gpu_sonar_timer_cb_queue_;
    bool is_used_gpu_sidescan_sonar_timer_cb_queue_;
...
private:
    ...
    public:
        ...
        rclcpp::Publisher<furosim_interfaces::msg::Environment>::SharedPtr env_pub_;
        furosim_interfaces::msg::Environment env_msg_;

        std::vector<SensorPublisher<furosim_interfaces::msg::Altimeter>> barometer_pubs_;
        ...
        std::vector<SensorPublisher<furosim_interfaces::msg::Pressure>> pressure_pubs_;
        std::vector<SensorPublisher<furosim_interfaces::msg::DVL>> dvl_pubs_;
        std::vector<SensorPublisher<sensor_msgs::msg::Image>> gpu_sonar_pubs_;
        std::vector<SensorPublisher<sensor_msgs::msg::Image>> gpu_sidescan_sonar_pubs_;
    ...
    public:
        ...
        rclcpp::Subscription<furosim_interfaces::msg::VelCmd>::SharedPtr vel_cmd_body_frame_sub_;
        rclcpp::Subscription<furosim_interfaces::msg::VelCmd>::SharedPtr vel_cmd_world_frame_sub_;

        rclcpp::Service<furosim_interfaces::srv::Takeoff>::SharedPtr takeoff_srvr_;
        rclcpp::Service<furosim_interfaces::srv::Land>::SharedPtr land_srvr_;

        bool has_vel_cmd_;
        VelCmd vel_cmd_;
    };

    class AuvROS : public VehicleROS
    {
    public:
        msr::airlib::AuvApiBase::AuvState curr_auv_state_;
    ...
    void lidar_timer_cb();
    void gpu_sonar_timer_cb();
    void gpu_sidescan_sonar_timer_cb();

    /// ROS subscriber callbacks
    void vel_cmd_world_frame_cb(const furosim_interfaces::msg::VelCmd::SharedPtr msg, const std::string& vehicle_name);
    void vel_cmd_body_frame_cb(const furosim_interfaces::msg::VelCmd::SharedPtr msg, const std::string& vehicle_name);

    void vel_cmd_group_body_frame_cb(const furosim_interfaces::msg::VelCmdGroup::SharedPtr msg);
    void vel_cmd_group_world_frame_cb(const furosim_interfaces::msg::VelCmdGroup::SharedPtr msg);

    void vel_cmd_all_world_frame_cb(const furosim_interfaces::msg::VelCmd::SharedPtr msg);
    void vel_cmd_all_body_frame_cb(const furosim_interfaces::msg::VelCmd::SharedPtr msg);

    void gimbal_angle_quat_cmd_cb(const furosim_interfaces::msg::GimbalAngleQuatCmd::SharedPtr gimbal_angle_quat_cmd_msg);
    void gimbal_angle_euler_cmd_cb(const furosim_interfaces::msg::GimbalAngleEulerCmd::SharedPtr gimbal_angle_euler_cmd_msg);
    ...
    bool takeoff_srv_cb(const std::shared_ptr<furosim_interfaces::srv::Takeoff::Request> request, const std::shared_ptr<furosim_interfaces::srv::Takeoff::Response> response, const std::string& vehicle_name);
    bool takeoff_group_srv_cb(const std::shared_ptr<furosim_interfaces::srv::TakeoffGroup::Request> request, const std::shared_ptr<furosim_interfaces::srv::TakeoffGroup::Response> response);
    bool takeoff_all_srv_cb(const std::shared_ptr<furosim_interfaces::srv::Takeoff::Request> request, const std::shared_ptr<furosim_interfaces::srv::Takeoff::Response> response);
    bool land_srv_cb(const std::shared_ptr<furosim_interfaces::srv::Land::Request> request, const std::shared_ptr<furosim_interfaces::srv::Land::Response> response, const std::string& vehicle_name);
    bool land_group_srv_cb(const std::shared_ptr<furosim_interfaces::srv::LandGroup::Request> request, const std::shared_ptr<furosim_interfaces::srv::LandGroup::Response> response);
    bool land_all_srv_cb(const std::shared_ptr<furosim_interfaces::srv::Land::Request> request, const std::shared_ptr<furosim_interfaces::srv::Land::Response> response);
    bool reset_srv_cb(const std::shared_ptr<furosim_interfaces::srv::Reset::Request> request, const std::shared_ptr<furosim_interfaces::srv::Reset::Response> response);
    ...
    // methods which parse setting json and generate ros pubsubsrv
    ...
    void append_static_gpu_sonar_tf(VehicleROS* vehicle_ros, const std::string& sonar_name, const msr::airlib::GpuSonarSimpleParams& sonar_setting);
    void append_static_gpu_sidescan_sonar_tf(VehicleROS* vehicle_ros, const std::string& sonar_name, const msr::airlib::GpuSidescanSonarSimpleParams& sonar_setting);
    ...
    nav_msgs::msg::Odometry get_odom_msg_from_auv_state(const msr::airlib::AuvApiBase::AuvState& auv_state) const;
    furosim_interfaces::msg::CarState get_roscarstate_msg_from_car_state(const msr::airlib::CarApiBase::CarState& car_state) const;
    msr::airlib::Pose get_airlib_pose(const float& x, const float& y, const float& z, const msr::airlib::Quaternionr& airlib_quat) const;
    furosim_interfaces::msg::GPSYaw get_gps_msg_from_airsim_geo_point(const msr::airlib::GeoPoint& geo_point) const;
    ...
    furosim_interfaces::msg::Altimeter get_altimeter_msg_from_airsim(const msr::airlib::BarometerBase::Output& alt_data) const;
    furosim_interfaces::msg::Pressure get_pressure_msg_from_airsim(const msr::airlib::PressureBase::Output& prs_data) const;
    furosim_interfaces::msg::DVL get_dvl_msg_from_airsim(const msr::airlib::DvlData& dvl_data) const;
    ...
    std::shared_ptr<sensor_msgs::msg::Image> get_gpu_sonar_img_msg_from_airsim(const msr::airlib::GpuSonarData& sonar_data, const std::string& vehicle_name, const std::string& sensor_name, int image_height, int image_width) const;
    std::shared_ptr<sensor_msgs::msg::Image> get_gpu_sidescan_sonar_img_msg_from_airsim(const msr::airlib::GpuSidescanSonarData& sonar_data, const std::string& vehicle_name, const std::string& sensor_name) const;
    ...
    furosim_interfaces::msg::Environment get_environment_msg_from_airsim(const msr::airlib::Environment::State& env_data) const;
    msr::airlib::GeoPoint get_origin_geo_point() const;
    VelCmd get_airlib_world_vel_cmd(const furosim_interfaces::msg::VelCmd& msg) const;
    VelCmd get_airlib_body_vel_cmd(const furosim_interfaces::msg::VelCmd& msg, const msr::airlib::Quaternionr& airlib_quat) const;
    ...
    msr::airlib::AuvRpcLibClient* get_auv_client();
    ...
    void convert_yaml_to_simple_mat(const YAML::Node& node, SimpleMatrix& m) const;
...
private:
    ...
    rclcpp::Subscription<furosim_interfaces::msg::VelCmd>::SharedPtr vel_cmd_all_body_frame_sub_;
    rclcpp::Subscription<furosim_interfaces::msg::VelCmd>::SharedPtr vel_cmd_all_world_frame_sub_;
    rclcpp::Service<furosim_interfaces::srv::Takeoff>::SharedPtr takeoff_all_srvr_;
    rclcpp::Service<furosim_interfaces::srv::Land>::SharedPtr land_all_srvr_;

    rclcpp::Subscription<furosim_interfaces::msg::VelCmdGroup>::SharedPtr vel_cmd_group_body_frame_sub_;
    rclcpp::Subscription<furosim_interfaces::msg::VelCmdGroup>::SharedPtr vel_cmd_group_world_frame_sub_;
    rclcpp::Service<furosim_interfaces::srv::TakeoffGroup>::SharedPtr takeoff_group_srvr_;
    rclcpp::Service<furosim_interfaces::srv::LandGroup>::SharedPtr land_group_srvr_;

    AIRSIM_MODE airsim_mode_ = AIRSIM_MODE::DRONE;

    rclcpp::Service<furosim_interfaces::srv::Reset>::SharedPtr reset_srvr_;
    rclcpp::Publisher<furosim_interfaces::msg::GPSYaw>::SharedPtr origin_geo_point_pub_;
    msr::airlib::GeoPoint origin_geo_point_;
    furosim_interfaces::msg::GPSYaw origin_geo_point_msg_;
    ...
    msr::airlib::RpcLibClientBase airsim_client_gpu_sonar_;
    msr::airlib::RpcLibClientBase airsim_client_gpu_sidescan_sonar_;
    ...
    rclcpp::TimerBase::SharedPtr airsim_gpu_sonar_update_timer_;
    rclcpp::TimerBase::SharedPtr airsim_gpu_sidescan_sonar_update_timer_;
    ...
    std::vector<rclcpp::CallbackGroup::SharedPtr> airsim_gpu_sonar_callback_groups_;
    std::vector<rclcpp::CallbackGroup::SharedPtr> airsim_gpu_sidescan_sonar_callback_groups_;
    ...
    rclcpp::Subscription<furosim_interfaces::msg::GimbalAngleQuatCmd>::SharedPtr gimbal_angle_quat_cmd_sub_;
    rclcpp::Subscription<furosim_interfaces::msg::GimbalAngleEulerCmd>::SharedPtr gimbal_angle_euler_cmd_sub_;
