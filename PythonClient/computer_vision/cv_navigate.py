...
def moveUAV(client,pos,yaw):
    client.simSetVehiclePose(furosim.Pose(furosim.Vector3r(pos[0], pos[1], pos[2]), furosim.to_quaternion(0, 0, yaw)), True) 
...
#furosim.wait_key('Press any key to start')
...
responses = client.simGetImages([
    furosim.ImageRequest("1", furosim.ImageType.DepthPlanar, True)])
...
for z in range(10000): # do few times
    ...
    if (target_dist < 1):
        ...
        furosim.wait_key('Press any key to continue')
        break
