...
cameraTypeMap = {
    "depth": furosim.ImageType.DepthVis,
    "segmentation": furosim.ImageType.Segmentation,
    "seg": furosim.ImageType.Segmentation,
    "scene": furosim.ImageType.Scene,
    "disparity": furosim.ImageType.DisparityNormalized,
    "normals": furosim.ImageType.SurfaceNormals
}
...
class ImageBenchmarker():
    def __init__(self,
            ...
            save_images = False,
            img_type = "scene"):
        self.airsim_client = furosim.VehicleClient()
    ...
    def image_callback_benchmark_simGetImages(self):
        self.image_benchmark_num_images += 1
        request = [furosim.ImageRequest(CAM_NAME, self.img_type, False, False)]
