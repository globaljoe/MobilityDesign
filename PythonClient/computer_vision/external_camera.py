...
requests = [furosim.ImageRequest(CAM_NAME, furosim.ImageType.Scene),
            furosim.ImageRequest(CAM_NAME, furosim.ImageType.DepthPlanar),
            furosim.ImageRequest(CAM_NAME, furosim.ImageType.DepthVis),
            furosim.ImageRequest(CAM_NAME, furosim.ImageType.Segmentation),
            furosim.ImageRequest(CAM_NAME, furosim.ImageType.SurfaceNormals)]
...
# Test FoV API
furosim.wait_key('Press any key to change FoV and get images')
...
# Test Pose APIs
new_pose = furosim.Pose(furosim.Vector3r(-10, -5, -5), furosim.to_quaternion(0.1, 0, 0.1))
