...
#gets the static meshes in the unreal scene
    ...
    def simSetObjectScale(self, object_name, scale_vector):
        ...
        Args:
            ...
            scale_vector (furosim.Vector3r): Desired scale of object
    ...
    def simSpawnObject(self, object_name, asset_name, pose, scale, physics_enabled=False, is_blueprint=False):
        ...
        Args:
            ...
            pose (furosim.Pose): Desired pose of object
            scale (furosim.Vector3r): Desired scale of object
...
#sensor APIs
    ...
    def getPressureData(self, pressure_name = '', vehicle_name = ''):
        """
        Args:
            pressure_name (str, optional): Name of Pressure Sensor to get data from, specified in settings.json
            vehicle_name (str, optional): Name of vehicle to which the sensor corresponds to

        Returns:
            PressureData:
        """
        return PressureData.from_msgpack(self.client.call('getPressureData', pressure_name, vehicle_name))
    ...
    def getGpuSonarData(self, sonar_name = '', vehicle_name = ''):
        ...
        Returns:
            GpuSonarData:
        """
        return GpuSonarData.from_msgpack(self.client.call('getGpuSonarData', sonar_name, vehicle_name))

    def getGpuSidescanSonarData(self, sonar_name = '', vehicle_name = ''):
        """
        Args:
            sonar_name (str, optional): Name of Sidescan Sonar to get data from, specified in settings.json
            vehicle_name (str, optional): Name of vehicle to which the sensor corresponds to

        Returns:
            GpuSidescanSonarData:
        """
        return GpuSidescanSonarData.from_msgpack(self.client.call('getGpuSidescanSonarData', sonar_name, vehicle_name))
...
#----------------------------------- Auv APIs ---------------------------------------------
class AuvClient(VehicleClient, object):
    def __init__(self, ip = "", port = 41451, timeout_value = 3600):
        super(AuvClient, self).__init__(ip, port, timeout_value)

    def setAuvControls(self, controls, vehicle_name = ''):
        """
        Control the auv using throttle, steering, brake, etc.

        Args:
            controls (AuvControls): Struct containing control values
            vehicle_name (str, optional): Name of vehicle to be controlled
        """
        self.client.call('setAuvControls', controls, vehicle_name)
    
    def getAuvState(self, vehicle_name = ''):
        """
        The position inside the returned AuvState is in the frame of the vehicle's starting point
    ...
    def setOceanCurrent(self, vx_north, vy_east, vz_down, vehicle_name=''):
        ...
        Args:
            vx_north (float): Current velocity toward north [m/s]
            vy_east  (float): Current velocity toward east  [m/s]
            vz_down  (float): Current velocity downward     [m/s]
            vehicle_name (str, optional): Name of vehicle
        """
