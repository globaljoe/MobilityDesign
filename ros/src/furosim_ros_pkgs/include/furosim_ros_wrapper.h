...
#include <furosim_ros_pkgs/VelCmd.h>
#include <furosim_ros_pkgs/VelCmdGroup.h>
#include <furosim_ros_pkgs/CarControls.h>
#include <furosim_ros_pkgs/CarState.h>
#include <furosim_ros_pkgs/Environment.h>
#include <chrono>
...
#include <furosim_ros_pkgs/Altimeter.h> //hector_uav_msgs defunct?
#include <furosim_ros_pkgs/Pressure.h>
#include <furosim_ros_pkgs/DVL.h>
...
public:
    ...
    ros::AsyncSpinner gpu_sonar_async_spinner_;
    ros::AsyncSpinner gpu_sidescan_sonar_async_spinner_;
...
private:
    ...
    public:
        ...
        std::vector<SensorPublisher> gpu_sonar_pubs;
        std::vector<SensorPublisher> gpu_sidescan_sonar_pubs;
    ...
    public:
        ...
        furosim_ros_pkgs::CarState car_state_msg;

        bool has_car_cmd;
        msr::airlib::CarApiBase::CarControls car_cmd;
    };

    class AsvROS : public VehicleROS
    {
    public:
        msr::airlib::AsvApiBase::AsvState curr_asv_state;

        // ros::Subscriber asv_cmd_sub;
        // ros::Publisher asv_state_pub;
        // furosim_ros_pkgs::AsvState asv_state_msg;

        // bool has_asv_cmd;
        // msr::airlib::AsvApiBase::AsvControls asv_cmd;
    };

    class AuvROS : public VehicleROS
    {
    public:
        msr::airlib::AuvApiBase::AuvState curr_auv_state;
    ...
    void gpu_sonar_timer_cb(const ros::TimerEvent& event);
    void gpu_sidescan_sonar_timer_cb(const ros::TimerEvent& event);

    /// ROS subscriber callbacks
    void vel_cmd_world_frame_cb(const furosim_ros_pkgs::VelCmd::ConstPtr& msg, const std::string& vehicle_name);
    void vel_cmd_body_frame_cb(const furosim_ros_pkgs::VelCmd::ConstPtr& msg, const std::string& vehicle_name);

    void vel_cmd_group_body_frame_cb(const furosim_ros_pkgs::VelCmdGroup& msg);
    void vel_cmd_group_world_frame_cb(const furosim_ros_pkgs::VelCmdGroup& msg);

    void vel_cmd_all_world_frame_cb(const furosim_ros_pkgs::VelCmd& msg);
    void vel_cmd_all_body_frame_cb(const furosim_ros_pkgs::VelCmd& msg);

    // void vel_cmd_body_frame_cb(const furosim_ros_pkgs::VelCmd& msg, const std::string& vehicle_name);
    void gimbal_angle_quat_cmd_cb(const furosim_ros_pkgs::GimbalAngleQuatCmd& gimbal_angle_quat_cmd_msg);
    void gimbal_angle_euler_cmd_cb(const furosim_ros_pkgs::GimbalAngleEulerCmd& gimbal_angle_euler_cmd_msg);
    ...
    bool takeoff_srv_cb(furosim_ros_pkgs::Takeoff::Request& request, furosim_ros_pkgs::Takeoff::Response& response, const std::string& vehicle_name);
    bool takeoff_group_srv_cb(furosim_ros_pkgs::TakeoffGroup::Request& request, furosim_ros_pkgs::TakeoffGroup::Response& response);
    bool takeoff_all_srv_cb(furosim_ros_pkgs::Takeoff::Request& request, furosim_ros_pkgs::Takeoff::Response& response);
    bool land_srv_cb(furosim_ros_pkgs::Land::Request& request, furosim_ros_pkgs::Land::Response& response, const std::string& vehicle_name);
    bool land_group_srv_cb(furosim_ros_pkgs::LandGroup::Request& request, furosim_ros_pkgs::LandGroup::Response& response);
    bool land_all_srv_cb(furosim_ros_pkgs::Land::Request& request, furosim_ros_pkgs::Land::Response& response);
    bool reset_srv_cb(furosim_ros_pkgs::Reset::Request& request, furosim_ros_pkgs::Reset::Response& response);
    ...
    void set_nans_to_zeros_in_pose(const VehicleSetting& vehicle_setting, GpuSonarSetting& sonar_setting) const;
    void set_nans_to_zeros_in_pose(const VehicleSetting& vehicle_setting, GpuSidescanSonarSetting& sonar_setting) const;
    ...
    nav_msgs::Odometry get_odom_msg_from_asv_state(const msr::airlib::AsvApiBase::AsvState& asv_state) const;
    nav_msgs::Odometry get_odom_msg_from_auv_state(const msr::airlib::AuvApiBase::AuvState& auv_state) const;
    furosim_ros_pkgs::CarState get_roscarstate_msg_from_car_state(const msr::airlib::CarApiBase::CarState& car_state) const;
    msr::airlib::Pose get_airlib_pose(const float& x, const float& y, const float& z, const msr::airlib::Quaternionr& airlib_quat) const;
    furosim_ros_pkgs::GPSYaw get_gps_msg_from_airsim_geo_point(const msr::airlib::GeoPoint& geo_point) const;
    ...
    furosim_ros_pkgs::Altimeter get_altimeter_msg_from_airsim(const msr::airlib::BarometerBase::Output& alt_data) const;
    furosim_ros_pkgs::Pressure get_pressure_msg_from_airsim(const msr::airlib::PressureBase::Output& alt_data) const;
    sensor_msgs::Range get_range_from_airsim(const msr::airlib::DistanceSensorData& dist_data) const;
    furosim_ros_pkgs::DVL get_dvl_msg_from_airsim(const msr::airlib::DvlData& dvl_data) const;
    ...
    sensor_msgs::ImagePtr get_gpu_sonar_img_msg_from_airsim(const msr::airlib::GpuSonarData& sonar_data, const std::string& vehicle_name, const std::string& sensor_name, int image_height, int image_width) const;
    sensor_msgs::ImagePtr get_gpu_sidescan_sonar_img_msg_from_airsim(const msr::airlib::GpuSidescanSonarData& sonar_data, const std::string& vehicle_name, const std::string& sensor_name) const;
    ...
    furosim_ros_pkgs::Environment get_environment_msg_from_airsim(const msr::airlib::Environment::State& env_data) const;
    ...
    msr::airlib::AsvRpcLibClient* get_asv_client();
...
private:
    ...
    furosim_ros_pkgs::GPSYaw origin_geo_point_msg_; // todo duplicate
    ...
    // todo not sure if async spinners shuold be inside this class, or should be instantiated in furosim_node.cpp, and cb queues should be public
    ...
    ros::CallbackQueue gpu_sonar_timer_cb_queue_;
    ros::CallbackQueue gpu_sidescan_sonar_timer_cb_queue_;
    ...
    ros::Timer airsim_gpu_sonar_update_timer_;
    ros::Timer airsim_gpu_sidescan_sonar_update_timer_;
